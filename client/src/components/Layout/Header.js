...
const Header = () => {
  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarTogglerDemo01">
      <Link className="navbar-brand" >NEXTCART</Link>
      <ul className="navbar-nav ms-auto mb-2 mb-lg-0" style={{marginRight:"3rem"}}><SearchInput/></ul>
      ...
      <ul className="navbar-nav ml-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          ...
          <>
          <li className="nav-item dropdown">
          <NavLink className="nav-link dropdown-toggle" role="button" data-bs-toggle="dropdown" aria-expanded="false" style={{border:"none"}}>
